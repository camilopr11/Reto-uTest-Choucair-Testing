...
Feature: uTest website register
  ...
  Scenario: User registration on uTest website
    ...
    When he fills all required personal information
      ...
      | Camilo       | Pastrana    | camilochoucairtesting@yopmail.com | March | 4   | 2000         | Medellín | 050032 | Colombia   | Windows     | 10                 | Spanish             | Xiaomi          | Pocophone F1   | Android 10  | Choucair2022* |
